...
function login($url,$data){
    $fp = fopen("cailonchau3.txt", "w");
    fclose($fp);
    $login = curl_init();
    curl_setopt($login, CURLOPT_COOKIEJAR, "cailonchau3.txt");
    curl_setopt($login, CURLOPT_COOKIEFILE, "cailonchau3.txt");
...
function grap_page($site){
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "cailonchau3.txt");
...
function post_data($site,$data){
    ...
    curl_setopt($datapost, CURLOPT_COOKIEFILE, "cailonchau3.txt");
    ob_start();
