...
function login($url,$data){
    $fp = fopen("cailonchau2.txt", "w");
    fclose($fp);
    $login = curl_init();
    curl_setopt($login, CURLOPT_COOKIEJAR, "cailonchau2.txt");
    curl_setopt($login, CURLOPT_COOKIEFILE, "cailonchau2.txt");
...
function grap_page($site){
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "cailonchau2.txt");
...
function post_data($site,$data){
    ...
    curl_setopt($datapost, CURLOPT_COOKIEFILE, "cailonchau2.txt");
    ob_start();
