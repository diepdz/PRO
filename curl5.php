...
function login($url,$data){
    ...
    fclose($fp);
    $login = curl_init();
    curl_setopt($login, CURLOPT_COOKIEJAR, "5.txt");
    curl_setopt($login, CURLOPT_COOKIEFILE, "5.txt");
...
function grap_page($site){
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "5.txt");
...
function post_data($site,$data){
    ...
    curl_setopt($datapost, CURLOPT_COOKIEFILE, "5.txt");
    ob_start();
