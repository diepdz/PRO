...
function login($url,$data){
    $fp = fopen("cailonchau.txt", "w");
    fclose($fp);
    $login = curl_init();
    curl_setopt($login, CURLOPT_COOKIEJAR, "cailonchau1.txt");
    curl_setopt($login, CURLOPT_COOKIEFILE, "cailonchau1.txt");
...
function grap_page($site){
    ...
    curl_setopt($ch, CURLOPT_COOKIEFILE, "cailonchau1.txt");
...
function post_data($site,$data){
    ...
    curl_setopt($datapost, CURLOPT_COOKIEFILE, "cailonchau1.txt");
    ob_start();
